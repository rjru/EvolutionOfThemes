...
if __name__ == '__main__':
    ...
    #txt = "Stemming programs are commonly referred to as stemming algorithms or stemmers."
    tokenLst = wordTokenize(txt, stemmingOption=True, rmStopwordsOption=True);
    fdist = nltk.FreqDist(ch.lower() for ch in tokenLst if ch.isalpha())
    print(fdist.most_common(5))

    tokenLst = wordTokenize(txt);
    freq = FreqDist(tokenLst)
