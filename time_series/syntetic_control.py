...
dis_matrix = getMatrixDist(ts_dataset_norm, fastdtw)  # DTWDistance dist_euclidean
a = numpy.asarray(dis_matrix)
numpy.savetxt("dis_matrix_time_series.csv", a, delimiter=",")
print(dis_matrix)
...
jsonfile = open("../clustering_process/result/syntetic_control.json", 'w')
# print(jsonTree)
